...
from .contracts import HK_RESIDUAL_MOMENTUM_QUALITY_PROFILE, get_profile_contract
from .residual_momentum_quality_strategy import compute_signals, score_candidates
...
def build_and_write_snapshot(
    *,
    ...
    contract = get_profile_contract(HK_RESIDUAL_MOMENTUM_QUALITY_PROFILE)
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--factor-snapshot", required=True, help="CSV with hk_residual_momentum_quality factor columns")
