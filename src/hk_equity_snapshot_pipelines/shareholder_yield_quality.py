...
from .contracts import HK_SHAREHOLDER_YIELD_QUALITY_PROFILE, get_profile_contract
from .shareholder_yield_quality_strategy import compute_signals, score_candidates
...
def build_and_write_snapshot(
    *,
    ...
    contract = get_profile_contract(HK_SHAREHOLDER_YIELD_QUALITY_PROFILE)
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--factor-snapshot", required=True, help="CSV with hk_shareholder_yield_quality factor columns")
