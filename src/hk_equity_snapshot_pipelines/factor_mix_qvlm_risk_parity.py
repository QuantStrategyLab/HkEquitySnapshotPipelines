...
from .contracts import HK_FACTOR_MIX_QVLM_RISK_PARITY_PROFILE, get_profile_contract
from .factor_mix_qvlm_risk_parity_strategy import compute_signals, score_candidates
...
def build_and_write_snapshot(
    *,
    ...
    contract = get_profile_contract(HK_FACTOR_MIX_QVLM_RISK_PARITY_PROFILE)
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        "--factor-snapshot",
        required=True,
        help="CSV with hk_factor_mix_qvlm_risk_parity factor columns",
    )
