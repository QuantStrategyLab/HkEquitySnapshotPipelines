...
from .central_soe_value_quality_select_strategy import compute_signals, score_candidates
from .contracts import HK_CENTRAL_SOE_VALUE_QUALITY_SELECT_PROFILE, get_profile_contract
...
def build_and_write_snapshot(
    *,
    ...
    contract = get_profile_contract(HK_CENTRAL_SOE_VALUE_QUALITY_SELECT_PROFILE)
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        "--factor-snapshot",
        required=True,
        help="CSV with hk_central_soe_value_quality_select factor columns",
    )
