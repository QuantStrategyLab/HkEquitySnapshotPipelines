...
from .composite_factor_quality_value_momentum_strategy import compute_signals, score_candidates
from .contracts import HK_COMPOSITE_FACTOR_QUALITY_VALUE_MOMENTUM_PROFILE, get_profile_contract
...
def build_and_write_snapshot(
    *,
    ...
    contract = get_profile_contract(HK_COMPOSITE_FACTOR_QUALITY_VALUE_MOMENTUM_PROFILE)
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        "--factor-snapshot",
        required=True,
        help="CSV with hk_composite_factor_quality_value_momentum columns",
    )
