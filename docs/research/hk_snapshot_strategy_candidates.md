...
- PolyU Asian quality-investing research reports that gross profitability and FSCORE strategies were studied in Hong Kong, Japan, Korea, Singapore, and Taiwan over 2000-2016, while Pacific-Basin FSCORE evidence and MSCI Hong Kong Quality methodology provide independent support for a low-turnover accounting-quality overlay. This is useful for future snapshot research, but only after point-in-time financial-statement availability, delisting, restatement, sector-comparability, liquidity, cost, and same-universe ablation controls. References: https://ira.lib.polyu.edu.hk/handle/10397/81583, https://link.springer.com/article/10.1057/s41260-020-00157-2, https://www.sciencedirect.com/science/article/pii/S0927538X16300804, https://www.msci.com/indexes/index/721604, and https://www.msci.com/eqb/methodology/meth_docs/MSCI_Quality_Indices_Methodology.pdf
- Hong Kong liquidity-asset-pricing research finds liquidity is important in HK return pricing, and global liquidity-risk research reports local liquidity risk premia in developed markets including Hong Kong. This supports a future Amihud / market-wide liquidity-risk capacity overlay, but only as risk and capacity control because buying illiquid names for a premium can be fragile under price impact, VCM/CAS, suspension, stale quotes, and liquidity-crash regimes. References: https://ideas.repec.org/a/eee/jbfina/v35y2011i9p2217-2230.html, https://www.sciencedirect.com/science/article/pii/S0378426611000367, https://www.sciencedirect.com/science/article/pii/S0378426612002014, https://www.hkex.com.hk/Market-Data/Statistics/Securities-Market?sc_lang=en, https://www.hkex.com.hk/Services/Trading/Securities/Overview/Trading-Mechanism?sc_lang=en, and https://www.hkex.com.hk/Global/Exchange/FAQ/Securities-Market/Trading/VCM?sc_lang=en
...
This policy is a gate, not a live switch: production ownership/fundamentals data, walk-forward evidence with max drawdown <= 30% and annual-return-to-max-drawdown ratio >= 0.50, artifact provenance, dry-run order-preview evidence, bilingual notifications, rollout controls, and operator approval remain mandatory before dry-run can be removed.
...
The promotion matrix still exposes `future_research_backlog` for ideas that are supported by external index/research evidence but are not active artifact contracts. The backlog now contains `hk_earnings_revision_quality_overlay`, a research-only candidate that should use point-in-time analyst EPS forecast revisions as an overlay on existing HK quality, value, low-volatility, dividend, and FCF sleeves rather than as a standalone high-turnover signal; `hk_low_size_quality_liquidity_premium`, a research-only candidate that should test whether low-size exposure still adds robust excess return after Hang Seng Low Size-style quality screening, industry controls, and capacity filters; `hk_stock_connect_inclusion_event_flow`, a research-only event candidate that should test Stock Connect inclusion/exclusion and sell-only transitions with Southbound turnover or CCASS holding confirmation; `hk_short_selling_pressure_risk_overlay`, a research-only overlay candidate that should use HKEX short-selling turnover, designated-shortable status, and short-interest ratio evidence as a crowded-long / short-squeeze / negative-information risk signal, not as a direct shorting strategy; `hk_director_dealing_disclosure_quality_overlay`, a research-only overlay candidate that should use only disclosed SFC/HKEX Disclosure of Interests / director-dealing notices as an alignment / undervaluation signal after filing-lag, correction/cancellation, blackout/moratorium, connected-person transfer, routine option-exercise, and buyback-overlap controls; `hk_dually_traded_liquid_reversal_overlay`, a research-only overlay candidate that should test liquid dually traded / cross-listed short-horizon reversal only after dual-listing mapping, foreign/HK close and FX alignment, weekly reversal signal, spread/fee/slippage/VCM/CAS, suspension, and capacity controls; `hk_earnings_announcement_drift_overlay`, a research-only event overlay candidate that should test HK PEAD, results-announcement, profit-warning, and alert reactions only after HKEXnews publication timestamps, board-meeting / trading-resumption context, earnings-surprise labels, bilingual announcement classification, short-sale eligibility, liquidity, slippage, and event-window cost controls; `hk_lottery_stock_risk_exclusion_overlay`, a research-only risk overlay candidate that should test high-IVOL / high-ISKEW / low-price / MAX-return lottery-like features as exclusions or underweights, not as a direct shorting strategy, after market-regime, liquidity, suspension, short-sale-eligibility, and cost controls; `hk_equity_financing_dilution_risk_overlay`, a research-only event overlay candidate that should test rights issues, open offers, placings, convertible issuance, and treasury-share sales as dilution / adverse-selection risk after announcement-type, issue-discount, use-of-proceeds, underwriting, shareholder-commitment, minority-approval, 2018 rule-change, completion/cancellation, and trading-halt/resumption controls; and `hk_connected_transaction_governance_risk_overlay`, a research-only event overlay candidate that should test connected transactions / related-party transactions as governance, tunneling, or expropriation risk after connected-person, ultimate-controller, transaction-type, pricing-policy, asset-valuation, independent-financial-adviser, independent-shareholder-approval, exemption, INED/auditor annual-review, and propping-versus-tunneling controls; and `hk_takeover_privatization_event_spread_overlay`, a research-only event overlay candidate that should test takeover, merger, privatisation, and possible-offer spreads only after Rule 3.7 / Rule 3.5 announcement classification, offer-period, offer-price/spread, conditions, acceptance, compulsory-acquisition / scheme, withdrawal/lapse, break-price, trading-halt, disclosure-dealing, liquidity, and capacity controls; and `hk_distribution_ex_date_entitlement_overlay`, a research-only event overlay candidate that should test ex-entitlement timing around cash dividends, special dividends, scrip dividends, stock distributions, bonus issues, splits, and consolidations only after ex-date, record-date, book-closure, payment-date, currency, adjustment-factor, exchange-adjusted previous-close, settlement, extreme-weather, ADR/dual-listing mismatch, liquidity, and cost controls; and `hk_ipo_lockup_overhang_event_overlay`, a research-only event overlay candidate that should test IPO listing, cornerstone lock-up expiry, pre-IPO investor lock-up expiry, and post-IPO supply overhang only after prospectus, offer-price, allotment-result, public-float, double-dipping, clawback, stabilization, block-trade, short-sale-eligibility, liquidity, and capacity controls; and `hk_audit_opinion_suspension_risk_overlay`, a research-only event overlay candidate that should test disclaimer, adverse, qualified, and going-concern audit opinions as audit-quality, suspension, resumption, and delisting risk after HKEX Rule 13.50A, remedial-period, long-suspension, auditor-resignation, forensic-investigation, resumption-guidance, liquidity, capacity, and same-universe ablation controls; and `hk_share_repurchase_execution_signal_overlay`, a research-only event overlay candidate that should test HKEX daily executed share-repurchase intensity, first repurchases, and repeat buyback windows as an undervaluation / capital-discipline signal after mandate/program/waiver, treasury-share retention/cancellation/resale, moratorium/blackout/connected-person, post-buyback financing/dilution, liquidity, capacity, and same-universe shareholder-yield ablation controls; and `hk_liquid_pairs_cointegration_stat_arb_overlay`, a research-only pair / basket relative-value candidate that should test only high-liquidity HK pairs after point-in-time pair universe, industry/beta matching, hedge ratio, cointegration strength, spread stationarity, half-life, Hurst exponent, breakdown flags, borrow/locate, designated short-selling, tick-rule, margin, VCM/CAS, suspension/one-leg gap, cost stress, and same-universe ablation controls; and `hk_macro_liquidity_inflation_rate_sensitivity_overlay`, a research-only macro risk / tilt overlay that should test Hong Kong CPI / inflation, HKMA base rate, overnight and one-month HIBOR, aggregate balance, HKD peg stress, and sector rate sensitivity only after release-lag, revision, currency-peg, property/financial concentration, same-universe ablation, cost, and capacity controls; and `hk_turn_of_month_lunar_new_year_calendar_overlay`, a research-only calendar risk / timing overlay that should test turn-of-month and Chinese Lunar New Year effects only after point-in-time HKEX trading-calendar, month-end/month-start, pre/post-holiday, severe-weather, settlement, Stock Connect holiday-mismatch, short-selling-turnover, liquidity, cost, crowding, and same-universe ablation controls; and `hk_etf_premium_discount_tracking_quality_overlay`, a research-only ETF product-quality overlay that should test premium/discount, NAV/iNAV, tracking difference, market-maker/spread/depth, creation/redemption, replication method, leveraged/inverse/futures-roll complexity, ETF Connect / Stock Connect status, holiday mismatch, broker permission, liquidity, cost, and same-universe ETF-rotation ablation before it can influence runtime ETF weights; and `hk_asset_growth_net_issuance_quality_overlay`, a research-only accounting-factor overlay that should test asset growth, net operating asset growth, capex/acquisition expansion, net share issuance, share-count change, and dilution risk only after point-in-time financial-statement reporting dates, restatements, sector exceptions, financial/property comparability, equity-financing and buyback reconciliation, liquidity, capacity, and same-universe quality/value/FCF/shareholder-yield ablations are audited; and `hk_accrual_quality_earnings_persistence_overlay`, a research-only accounting-quality overlay that should test operating accruals, working-capital accruals, cash conversion, receivables/inventory/payables changes, earnings persistence, restatements, auditor changes, qualified opinions, sector exceptions, liquidity, transaction costs, and same-universe FCF / quality-growth / low-vol / value-quality / asset-growth ablations before it can influence snapshot weights; and `hk_fscore_gross_profitability_quality_overlay`, a research-only accounting-quality / value overlay that should test Piotroski FSCORE, gross profitability, cash conversion, leverage/liquidity, share issuance, gross margin, asset turnover, reporting-date lag, restatements, delistings, sector exceptions, liquidity, transaction costs, and same-universe FCF / quality-growth / shareholder-yield / asset-growth / accrual / low-size / momentum ablations before it can influence snapshot weights; and `hk_shareholding_concentration_free_float_risk_overlay`, a research-only ownership-liquidity risk overlay that should test SFC high-shareholding-concentration announcements, CCASS participant concentration, free-float / public-float pressure, unexplained price-volume ramps, stale notices, stock-code reuse, and ramp-and-dump red flags only as tail-risk exclusions or downweights before it can influence snapshot weights; and `hk_amihud_liquidity_risk_capacity_overlay`, a research-only liquidity-risk / capacity overlay that should test Amihud illiquidity, market-wide liquidity shocks, liquidity beta, zero-volume / turnover, spread/depth, HKEX market-turnover, VCM/CAS, board-lot / odd-lot, suspension, stale-quote, price-impact, same-universe ablation, cost, and capacity stress before it can influence snapshot weights; and `hk_analyst_dispersion_coverage_risk_overlay`, a research-only consensus-risk / quality overlay that should test analyst forecast dispersion, coverage count/drop, recommendation and target-price disagreement, forecast accuracy/bias, estimate staleness, publication lag, vendor lineage, policy-uncertainty context, sparse-coverage small caps, sector crowding, and same-universe earnings-revision / momentum / quality-value / liquidity / short-selling / event ablations before it can influence snapshot weights; and `hk_financial_distress_deleveraging_risk_overlay`, a research-only financial-distress / deleveraging risk overlay that should test point-in-time Z-score, leverage, interest coverage, debt maturity, cash-flow liquidity, refinancing/default-risk, property exposure, going-concern, long-suspension, delisting, HIBOR/base-rate and property-downturn regimes, and same-universe audit-opinion / accrual / asset-growth / FSCORE / liquidity / quality-yield / momentum ablations before it can influence snapshot weights. HKEX audit-opinion suspension rules and long-suspension guidance support the fourteenth direction, while audit-qualification and going-concern research suggests audit opinions can have information value; the architecture must therefore be a risk exclusion / underweight overlay rather than a live resumption-trading strategy. HKEX daily share-repurchase reports, the 2024 treasury-share regime, and Hong Kong buyback research support the fifteenth direction, but it must stay distinct from `hk_shareholder_yield_quality` until actual execution, treasury-share, and post-buyback dilution evidence are audited. Hong Kong pairs-trading research supports the sixteenth direction, while HKEX covered-short-sale, designated-security, tick-rule, VCM/CAS, borrow, margin, and capacity requirements keep it research-only until two-leg execution is proven. Hong Kong stock-return-driver research and official HKMA / HKAB / C&SD data support the seventeenth direction, but it must stay a macro overlay because CPI, base-rate, HIBOR, and liquidity series require publication-lag, revision, peg-regime, and sector-sensitivity controls before live use. Turn-of-month and Chinese Lunar New Year anomaly research, plus HKEX trading-calendar and severe-weather rules, support the eighteenth direction, but it must stay an overlay because calendar effects are vulnerable to data mining, holiday mismatch, crowding, and execution-cost decay. Hong Kong ETF tracking-error and premium-pattern research, plus HKEX / SFC / HKMA product-risk material, supports the nineteenth direction, but it must stay a product-quality overlay because premium arbitrage is fragile under stale NAV, overseas-underlying close gaps, market-maker withdrawal, complex-product constraints, and broker permission failures. Asset-growth research warns that the anomaly can be capacity-, liquidity-, and arbitrage-risk constrained, which supports the twentieth direction as a low-turnover quality / dilution-risk overlay rather than a standalone live anomaly strategy. Accrual-anomaly and earnings-quality research supports the twenty-first direction, but it must stay an accounting-quality overlay because accrual signals can be confounded by risk, liquidity, transaction costs, restatements, and reporting-date frictions. PolyU Asian quality-investing research, Pacific-Basin FSCORE evidence, and MSCI Hong Kong Quality methodology support the twenty-second direction, but it must stay an accounting-quality / value overlay because FSCORE and gross-profitability effects can be confounded by small-cap liquidity, reporting lag, restatements, sector comparability, and factor crowding. SFC high-shareholding-concentration notices, CCASS shareholding data, and SFC ramp-and-dump red-flag guidance support the twenty-third direction, but it must stay a risk-exclusion / downweight overlay because stale notices, stock-code reuse, thin liquidity, and public-float restoration can otherwise create false positives. Hong Kong liquidity-asset-pricing research, global liquidity-risk evidence, and HKEX market statistics / trading-mechanism / VCM sources support the twenty-fourth direction, but it must stay a liquidity-risk and capacity overlay because illiquidity premia can disappear after price impact, spread widening, stale quotes, suspensions, and forced-deleveraging regimes. Hong Kong analyst-behavior and forecast-dispersion research supports the twenty-fifth direction, but it must stay a consensus-risk overlay because forecast dispersion, target-price disagreement, stale coverage, broker bias, and coverage droughts can proxy for uncertainty or data availability rather than tradable alpha. IMF Hong Kong corporate-vulnerability work, HK financial-distress prediction research, and HKSE Z-score evidence support the twenty-sixth direction, but it must stay a downside-risk overlay because distressed rebounds, stale financials, suspensions, property-cycle shocks, and refinancing windows can otherwise create look-ahead or bottom-fishing bias. S&P DJI earnings-revision research supports testing the first direction in Asia but also highlights why an overlay is more practical than a standalone strategy when turnover is high. Hang Seng Low Size methodology and smart-beta materials support testing the second direction, but only with free-float market-cap, HSICS industry, ROE / debt-to-equity / EPS-variability quality screens, ADV, spread, board-lot, suspension, and free-float capacity controls. HKEX eligible-securities lists and expansion announcements support testing the third direction, while event-study evidence suggests inclusion/exclusion effects can decay, so signal-decay and crowding stress are mandatory. HKEX regulated-short-selling data and Hong Kong short-sale research support testing the fourth direction, while squeeze, borrow, tick-rule, and option-hedging controls remain mandatory. SFC Part XV / DI Notices and HKEX Disclosure of Interests data support the fifth direction as a legal disclosed-information overlay, and Hong Kong director-dealing / share-repurchase research suggests the signal can interact with buyback undervaluation evidence, so illegal-insider-information language and trading assumptions must be avoided. Hong Kong contrarian / reversal research supports the sixth direction, but transaction costs can erase short-term overreaction profits, so the design must be restricted to liquid, execution-audited dually traded names and stay non-live until walk-forward evidence passes. HK PEAD and profit-warning / alert research supports the seventh direction, while HKEXnews and HKEX listed-issuer disclosure rules make publication timestamp, trading resumption, language parsing, and public-information-only controls mandatory. Hong Kong lottery-stock research supports the eighth direction because stronger current-month lottery features are linked to poorer next-month average returns, but the right architecture is an exclusion / underweight overlay with liquidity and short-sale constraints rather than a standalone short strategy. Hong Kong equity-financing research supports the ninth direction because rights offers have large negative announcement reactions while placements and long-run SEO effects differ, so the architecture must be an event-risk overlay that distinguishes financing type and dilution rather than a blind short signal. Hong Kong connected-transaction research supports the tenth direction because some connected-party transaction categories are associated with negative announcement and 12-month excess returns, while later evidence suggests independent directors can improve RPT value, so the architecture must distinguish tunneling/expropriation from propping or strategic transactions. Hong Kong takeover and privatisation research supports the eleventh direction because target shareholders can earn large positive announcement returns, but going-private transactions and possible-offer talks also carry tunneling, completion, and break-price risks, so the architecture must be a completion-risk-aware event-spread overlay rather than a live merger-arbitrage strategy. Hong Kong ex-dividend and stock-distribution research supports the twelfth direction because older ex-day return anomalies existed in Hong Kong but weakened after electronic settlement, while later evidence highlights price-adjustment, ADR timing, and anchoring effects, so the architecture must stay event-audited and cost-aware rather than a live dividend-capture strategy. Hong Kong IPO and lock-up research supports the thirteenth direction because cornerstone investors and pre-IPO investors create observable lock-up schedules and potential supply overhang, while IPO underpricing, subscription costs, stabilization, block trades, and long-run underperformance make it unsuitable as a direct IPO flipping or short-lockup strategy. References: https://www.spglobal.com/spdji/en/research/article/earnings-revision-overlay-on-fundamental-factors-in-asia/, https://www.spglobal.com/spdji/en/documents/research/research-do-earnings-revisions-matter-in-asia.pdf, https://www.hsi.com.hk/static/uploads/contents/en/dl_centre/methodologies/IM_hssbisse.pdf, https://www.hsi.com.hk/static/uploads/contents/en/news/pressRelease/20210118T000000.pdf, https://www.hsi.com.hk/static/uploads/contents/en/dl_centre/research_paper/20220408T000000.pdf, https://www.hkex.com.hk/Mutual-Market/Stock-Connect/Eligible-Stocks/View-All-Eligible-Securities?sc_lang=en, https://www.hkex.com.hk/News/News-Release/2023/230303news?sc_lang=en, https://www.hkex.com.hk/-/media/HKEX-Market/Mutual-Market/Stock-Connect/Getting-Started/Information-Booklet-and-FAQ/FAQ/FAQ_En.pdf, https://econpapers.repec.org/article/kapapfinm/v_3a30_3ay_3a2023_3ai_3a4_3ad_3a10.1007_5fs10690-022-09395-3.htm, https://www.hkex.com.hk/Services/Trading/Securities/Overview/Regulated-Short-Selling?sc_lang=en, https://www.hkex.com.hk/Market-Data/Statistics/Securities-Market/Short-Selling-Turnover-Today?sc_lang=en, https://papers.ssrn.com/sol3/papers.cfm?abstract_id=2434387, https://www.sciencedirect.com/science/article/pii/S0378426609002064, https://www.sfc.hk/en/Rules-and-standards/Securities-and-Futures-Ordinance-Part-XV---Disclosure-of-Interests?oldnode=0, https://www.sfc.hk/en/Rules-and-standards/Securities-and-Futures-Ordinance-Part-XV---Disclosure-of-Interests/DI-Notices, https://www2.hkexnews.hk/Shareholding-Disclosures/Disclosure-of-Interests?sc_lang=en, https://econpapers.repec.org/paper/hkmwpaper/222008.htm, https://www.sciencedirect.com/science/article/abs/pii/S1042443110000338, https://www.sciencedirect.com/science/article/abs/pii/S0927538X10000600, https://ideas.repec.org/a/taf/applec/v46y2014i12p1335-1349.html, https://www.tandfonline.com/doi/abs/10.1207/S15427579JPFM0403_5, https://scholars.hkbu.edu.hk/en/publications/intraday-price-reversals-for-index-futures-in-the-us-and-hong-kon, https://www.hkex.com.hk/Services/Trading/Securities/Overview/Trading-Mechanism?sc_lang=en, https://www.hkex.com.hk/Services/Rules-and-Forms-and-Fees/Fees/Securities-%28Hong-Kong%29/Trading/Transaction?sc_lang=en, https://theses.lib.polyu.edu.hk/handle/200/4070, https://www.hkex.com.hk/Listing/Explore-By-Role/Listed-Issuers/Equity-Securities?sc_lang=en, https://www.hkex.com.hk/-/media/HKEX-Market/Listing/Rules-and-Guidance/eSubmission-System/Listed-Company-Information-Dissemination-and-Related-Trading-Arrangements/faqinv.pdf, https://www.hkex.com.hk/-/media/HKEX-Market/Listing/Rules-and-Guidance/Archive/Frequently-Asked-Questions/FAQ10_eng.pdf, https://www.hkexnews.hk/listedco/listconews/advancedsearch/search_active_main.aspx, https://www.sciencedirect.com/science/article/abs/pii/S1544612315001439, https://link.springer.com/article/10.1007/s11156-017-0623-3, https://ira.lib.polyu.edu.hk/bitstream/10397/61456/1/Chan_Gambling_Hong_Kong.pdf, https://www.sciencedirect.com/science/article/abs/pii/S1059056016300259, https://www.sciencedirect.com/science/article/abs/pii/S0927538X13000425, https://theses.lib.polyu.edu.hk/handle/200/2513, https://www.sciencedirect.com/science/article/abs/pii/S0927538X13000929, https://www.sciencedirect.com/science/article/abs/pii/S0927538X0500048X, https://www.hkex.com.hk/News/Regulatory-Announcements/2018/180504news?sc_lang=en, https://www.hkex.com.hk/Listing/Rules-and-Guidance/Forms/Equity-Securities-Issuers/Main-Board-Issuers?sc_lang=en, https://papers.ssrn.com/sol3/papers.cfm?abstract_id=1008780, https://www.sciencedirect.com/science/article/pii/S0144818825000171, https://www.sciencedirect.com/science/article/pii/S0378426608002318, https://www.sciencedirect.com/science/article/pii/S0927538X11000400, https://en-rules.hkex.com.hk/entiresection/1214, https://www.hkex.com.hk/Listing/Listed-Issuers/e-Learning/Connected-Transaction-Rules?sc_lang=en, https://www.sfc.hk/en/Regulatory-functions/Corporates/Takeovers-and-mergers, https://www.sfc.hk/en/Regulatory-functions/Corporates/Takeovers-and-mergers/Transaction-announcements-and-documents, https://www.sfc.hk/en/Regulatory-functions/Corporates/Takeovers-and-mergers/offer-periods, https://www.sfc.hk/en/Regulatory-functions/Corporates/Takeovers-and-mergers/past-offer-periods, https://www.sciencedirect.com/science/article/abs/pii/S089083898371022X, https://www.sciencedirect.com/science/article/pii/S0927538X12000765, https://theses.lib.polyu.edu.hk/handle/200/2926, https://www.hkex.com.hk/-/media/HKEX-Market/Listing/Rules-and-Guidance/Other-Resources/Listed-Issuers/Practices-and-Procedures-for-Handling-Listing-related-Matters/f_div.pdf, https://www3.hkexnews.hk/reports/doe/eentgem.htm, https://www.hkex.com.hk/Services/Trading/Securities/Overview/Trading-Mechanism?sc_lang=en, https://ideas.repec.org/a/bla/jfinan/v55y2000i6p2841-2861.html, https://www.sciencedirect.com/science/article/pii/S0378426609002362, https://www.sciencedirect.com/science/article/pii/S1057521915000873, https://hub.hku.hk/handle/10722/243215, https://www.hkex.com.hk/-/media/HKEX-Market/Listing/Rules-and-Guidance/Interpretation-and-Guidance/Guide-for-New-Listing-Applicants/chapter_4.pdf, https://www.hkex.com.hk/Global/Exchange/FAQ/List-with-HKEX?sc_lang=en, https://www.hkex.com.hk/News/Regulatory-Announcements/2023/2311212news, https://en-rules.hkex.com.hk/sites/default/files/net_file_store/gl4312.pdf, https://www.sciencedirect.com/science/article/abs/pii/S0927538X06000680, https://www.sciencedirect.com/science/article/pii/S1042443109000353, https://papers.ssrn.com/sol3/papers.cfm?abstract_id=2647696, and https://research.birmingham.ac.uk/en/publications/long-run-performance-of-ipos-the-role-of-lockups, https://www.hkex.com.hk/News/Regulatory-Announcements/2019/190524news?sc_lang=en, https://en-rules.hkex.com.hk/rulebook/1350a, https://www.hkex.com.hk/-/media/HKEX-Market/Listing/Rules-and-Guidance/Archive/Guidance-Letters/gl95_18.pdf, https://www.sciencedirect.com/science/article/pii/0165410184900181, https://researchportal.hkust.edu.hk/en/publications/going-concern-opinions-and-the-markets-reaction-to-bankruptcy-fil/, https://www3.hkexnews.hk/reports/sharerepur/sbn.asp, https://www.hkex.com.hk/-/media/HKEX-Market/Listing/Rules-and-Guidance/Other-Resources/Listed-Issuers/LIR-Newsletter/newsletter_202506.pdf, https://en-rules.hkex.com.hk/rulebook/9-repurchase-securities-and-treasury-shares, https://www.hkex.com.hk/News/Regulatory-Announcements/2024/240412news?sc_lang=en, and https://journals.sagepub.com/doi/10.1177/097265270500400301, https://ideas.repec.org/p/war/wpaper/2022-02.html, https://hub.hku.hk/handle/10722/261387, https://www.sciencedirect.com/science/article/abs/pii/S1059056017300254, https://www.hkex.com.hk/Services/Trading/Securities/Overview/Regulated-Short-Selling?sc_lang=en, https://www.sciedu.ca/journal/index.php/afr/article/view/16166, https://www.sciencedirect.com/science/article/pii/S0378426611000367, https://www.hkma.gov.hk/eng/key-functions/money/liquidity-facility-framework/base-rate/, https://apidocs.hkma.gov.hk/documentation/market-data-and-statistics/daily-monetary-statistics/daily-figures-interbank-liquidity/, https://www.hkab.org.hk/en/rates/hibor, and https://www.censtatd.gov.hk/en/scode270.html?productCode=FA100024, https://www.imf.org/en/publications/selected-issues-papers/issues/2025/05/05/corporate-sector-vulnerabilities-in-hong-kong-sar-hong-kong-special-administrative-region-566684, https://www.mdpi.com/2071-1050/7/2/1186, https://researchportal.hkust.edu.hk/en/publications/clientele-change-liquidity-shock-and-the-return-on-financially-di/, and https://journals.sagepub.com/doi/full/10.1177/18479790231165603. `future_research_live_enablement_policy` keeps these and any newly discovered non-scaffolded ideas explicitly non-selectable until each new idea receives a new snapshot profile name, a new contract version, candidate-specific source-audit fields, point-in-time factor/classification, consensus-estimate revision, free-float market-cap, Stock Connect eligibility-change, designated short-selling, short-turnover, disclosed-interest / director-dealing notice, dually traded mapping / reversal cost, HKEXnews announcement / profit-warning / earnings-surprise timestamp history, lottery-feature IVOL/ISKEW/MAX/price history, equity-financing rights/open-offer/placement/convertible dilution history, connected-transaction announcement/circular/shareholder-approval and governance-risk history, takeover possible-offer/firm-intention/offer-period/spread/completion-risk history, distribution ex-date/record-date/payment/price-adjustment/settlement history, IPO listing/cornerstone/pre-IPO lock-up expiry/overhang/stabilization history, audit-opinion disclaimer/adverse/qualified/going-concern/suspension/resumption/delisting history, share-repurchase daily execution / mandate / treasury-share retention-resale / post-buyback dilution history, pairs cointegration / spread stability / borrow-shortability / pair-leg cost history, liquidity, and capacity history, analyst coverage/vendor, HSICS, official eligible-security methodology, HKEX regulated-short-selling controls, or SFC/HKEX DI-notice filing-lag / blackout / moratorium context, same-universe ablation against existing quality/yield, momentum, and special-situation profiles, walk-forward evidence versus `02800` and the candidate benchmark, drawdown/turnover/capacity controls, artifact provenance, dry-run order-preview evidence, bilingual notifications, rollout controls, and operator approval. This avoids silently turning a research idea into a live profile by mutating an existing contract in place.
...
- walk-forward tests include positive annual return, max drawdown under 30%, annual-return-to-max-drawdown ratio >= 0.50, profile-compliant annualized turnover, fees, stamp duty, lot-size rounding, missing flow days, and holiday-adjusted flow windows;
- platform dry-run confirms artifact loading, order preview, notifications, and rollback on both IBKR and LongBridge.
...
## 2026-06-02 downside beta / tail-risk volatility overlay

`hk_downside_beta_tail_risk_volatility_overlay` is added as a research-only drawdown-control overlay. The research thesis is to test whether downside beta, semivariance, realized-volatility regime, VaR/CVaR, tail-loss contribution, and stress beta can reduce drawdown or improve capacity when applied as an exclusion / downweight overlay to HK quality, value, yield, momentum, event, ETF, liquidity, and financial-distress sleeves. It is not a standalone volatility-timing, short-volatility, volatility-arbitrage, leveraged de-risk/re-risk, or short-selling strategy.

新增 `hk_downside_beta_tail_risk_volatility_overlay` 作为 research-only 下行风险控制 overlay。研究重点是验证 downside beta、semivariance、realized-volatility regime、VaR/CVaR、tail-loss contribution 和 stress beta 是否能在港股 quality、value、yield、momentum、event、ETF、liquidity、financial-distress sleeves 上作为排除 / 降权 overlay 降低回撤或改善容量。它不是单独的波动率择时、short-vol、vol-arb、杠杆化 de-risk/re-risk 或做空策略。

Promotion blockers: new profile/contract only; point-in-time price, return, quote, liquidity, suspension, and corporate-action-adjusted inputs; no full-sample crash labels; same-universe ablations versus low-vol dividend, quality-growth low-volatility, lottery, Amihud liquidity, financial distress, quality/value/yield, momentum, event, and ETF overlays; stress tests for 2008/2015/2020/2022-style crash windows, volatility clustering, whipsaw de-risk/re-risk cycles, suspensions, stale quotes, China policy/property shocks, HIBOR/base-rate shocks, costs, and capacity; and walk-forward evidence with max drawdown <= 30%, every OOS fold drawdown <= 30%, at least 3 independent OOS folds, max single-period contribution <= 60%, annual-return-to-max-drawdown ratio >= 0.50, positive net excess return after costs, dry-run order previews, bilingual notifications, rollout controls, and operator approval.

## 2026-06-02 structured-product warrant / CBBC flow overlay

`hk_structured_product_warrant_cbbc_flow_risk_overlay` is added as a research-only HK structured-product flow and tail-risk overlay. The research thesis is to test whether derivative-warrant and CBBC issuance, turnover, call/put or bull/bear imbalance, maturity/strike clustering, mandatory-call-event proximity, and liquidity-provider quote / hedging stress can identify crowded retail flow, hedging pressure, or short-horizon tail-risk around large-cap tech, index, ETF, momentum, liquidity, and event sleeves. It must not become a direct derivative-warrant, CBBC, knockout, market-making, or issuer-hedging-front-running strategy.

新增 `hk_structured_product_warrant_cbbc_flow_risk_overlay` 作为 research-only 港股结构化产品 flow / tail-risk overlay。研究重点是验证 derivative warrants 和 CBBC 的发行、成交、call/put 或 bull/bear imbalance、maturity/strike clustering、mandatory-call-event proximity、liquidity-provider quote / hedging stress 是否能识别大型科技股、指数、ETF、momentum、liquidity 和 event sleeves 的拥挤散户资金、对冲压力或短周期尾部风险。它不能成为直接交易权证/牛熊证、knockout、market-making 或 issuer-hedging-front-running 策略。

## 2026-06-02 index futures / options sentiment-basis overlay

`hk_index_derivatives_futures_options_sentiment_basis_overlay` is added as a research-only HK index-derivatives sentiment and regime overlay. The research thesis is to test whether HSI, HSTECH, HSCEI, and related HKEX index futures/options basis, calendar spread, put-call open-interest ratio, implied-volatility skew, term structure, expiry-roll, and spot-futures-options lead-lag signals can improve ETF rotation, large-cap, momentum, downside-risk, macro, and structured-product sleeves. It must not become a direct futures, options, volatility, margin, leverage, or spread-trading strategy.

新增 `hk_index_derivatives_futures_options_sentiment_basis_overlay` 作为 research-only 港股指数衍生品情绪 / regime overlay。研究重点是验证 HSI、HSTECH、HSCEI 及相关 HKEX index futures/options 的 basis、calendar spread、put-call open-interest ratio、implied-volatility skew、term structure、expiry-roll 和 spot-futures-options lead-lag 信号是否能改善 ETF rotation、大盘股、momentum、downside-risk、macro 和 structured-product sleeves。它不能成为直接期货、期权、波动率、保证金、杠杆或 spread-trading 策略。

## 2026-06-02 VCM / CAS microstructure shock overlay

`hk_vcm_cas_microstructure_shock_risk_overlay` is added as a research-only HK microstructure shock and execution-risk overlay. The research thesis is to test whether VCM triggers, cooling-off price bands, POS/CAS auction limits, reference prices, auction-session context, derivatives VCM coverage, and broker order-preview rejection evidence can reduce drawdown or execution slippage in momentum, event, ETF, liquidity, downside-risk, structured-product, and index-derivatives sleeves. It must not become a high-frequency VCM-trigger, auction-sniping, market-making, latency, or order-book strategy.

新增 `hk_vcm_cas_microstructure_shock_risk_overlay` 作为 research-only 港股微观结构冲击 / 执行风险 overlay。研究重点是验证 VCM trigger、cooling-off price band、POS/CAS auction limit、reference price、auction-session context、derivatives VCM coverage 和 broker order-preview rejection evidence 是否能降低 momentum、event、ETF、liquidity、downside-risk、structured-product 和 index-derivatives sleeves 的回撤或执行滑点。它不能成为高频 VCM trigger、auction-sniping、market-making、latency 或 order-book 策略。

## 2026-06-02 REIT dividend-spread / rate-sensitivity overlay

`hk_reit_dividend_spread_rate_sensitivity_overlay` is added as a research-only HK REIT income and rate-risk overlay. The research thesis is to test whether HK-listed REIT distribution yield, NAV / GAV discount, gearing, property-sector exposure, rental growth / reversion, debt maturity, HIBOR / base-rate sensitivity, and yield-spread regimes can improve dividend, quality-yield, macro-rate, ETF, and defensive rotation sleeves. It must not become a leveraged REIT carry, margin, property-developer proxy, or dividend-capture strategy.

新增 `hk_reit_dividend_spread_rate_sensitivity_overlay` 作为 research-only 港股 REIT income / rate-risk overlay。研究重点是验证 HK-listed REIT distribution yield、NAV / GAV discount、gearing、property-sector exposure、rental growth / reversion、debt maturity、HIBOR / base-rate sensitivity 和 yield-spread regime 是否能改善 dividend、quality-yield、macro-rate、ETF 与 defensive rotation sleeves。它不能成为 leveraged REIT carry、margin、property-developer proxy 或 dividend-capture 策略。

## 2026-06-02 regulatory enforcement / disciplinary risk overlay

`hk_regulatory_enforcement_disciplinary_risk_overlay` is added as a research-only HK governance, disclosure and market-misconduct risk overlay. The research thesis is to test whether HKEX disciplinary sanctions / enforcement bulletins, SFC enforcement actions, Market Misconduct Tribunal outcomes, restriction notices, false-disclosure cases, director unsuitability statements, and remedial-action evidence can reduce tail risk or improve drawdown control in quality, value, yield, event, liquidity, and small-cap sleeves. It must not become a rumour-trading, event-chasing, litigation-arbitrage, or short-selling strategy.

新增 `hk_regulatory_enforcement_disciplinary_risk_overlay` 作为 research-only 港股治理、披露与市场失当风险 overlay。研究重点是验证 HKEX disciplinary sanctions / enforcement bulletins、SFC enforcement actions、Market Misconduct Tribunal outcomes、restriction notices、false-disclosure cases、director unsuitability statements 和 remedial-action evidence 是否能降低 quality、value、yield、event、liquidity 与 small-cap sleeves 的尾部风险或改善回撤控制。它不能成为 rumour-trading、event-chasing、litigation-arbitrage 或 short-selling 策略。

## 2026-06-02 margin financing / collateral forced-selling risk overlay

`hk_margin_financing_collateral_forced_selling_risk_overlay` is added as a research-only HK deleveraging and collateral-risk overlay. The research thesis is to test whether securities margin financing, broker collateral concentration, marginable-security eligibility, haircut / loan-to-value changes, controlling-shareholder share pledges, margin-call pressure, and forced-selling liquidity gaps can reduce drawdown or tail risk in low-size, liquidity, lottery, governance, distress, momentum, value, and event sleeves. It must not become a leveraged margin-trading, forced-liquidation front-running, rumour-trading, or short-selling strategy.

新增 `hk_margin_financing_collateral_forced_selling_risk_overlay` 作为 research-only 港股去杠杆 / 抵押品风险 overlay。研究重点是验证 securities margin financing、broker collateral concentration、marginable-security eligibility、haircut / loan-to-value change、controlling-shareholder share pledge、margin-call pressure 和 forced-selling liquidity gap 是否能降低 low-size、liquidity、lottery、governance、distress、momentum、value 与 event sleeves 的回撤或尾部风险。它不能成为 leveraged margin-trading、forced-liquidation front-running、rumour-trading 或 short-selling 策略。

## 2026-06-02 liquid large-cap weekly reversal cost-aware overlay

`hk_liquid_largecap_weekly_reversal_cost_aware_overlay` is added as a research-only HK reversal / overreaction candidate. The research thesis is to test whether weekly extreme-return reversal / continuance evidence can become a liquid-large-cap, execution-aware overlay only when realistic fees, spreads, slippage, bid-ask bounce, VCM/CAS, suspension and capacity controls leave positive net excess return. It must not become an intraday, high-turnover, microcap, penny-stock, opening-gap, or pure contrarian trading strategy.

新增 `hk_liquid_largecap_weekly_reversal_cost_aware_overlay` 作为 research-only 港股反转 / overreaction 候选。研究重点是验证 weekly extreme-return reversal / continuance 证据是否只有在 liquid-large-cap universe 中、且真实 fee、spread、slippage、bid-ask bounce、VCM/CAS、suspension 和 capacity 控制后仍保留正净超额收益时，才能作为 execution-aware overlay。它不能成为 intraday、高换手、microcap、penny-stock、opening-gap 或纯 contrarian trading 策略。


## 2026-06-02 US ADR / HK secondary-listing lead-lag overlay

`hk_us_adr_hk_secondary_listing_lead_lag_overlay` is added as a research-only cross-market lead-lag / price-discovery overlay. The research thesis is to test whether US ADR overnight / day-session moves, HK secondary-listing close/open alignment, ADR ratio, USD/HKD FX, after-hours / pre-market context, holiday mismatch, and conversion/fungibility constraints can improve confirmation or de-risking for HK China-tech, large-cap momentum, ETF rotation, weekly reversal, and event sleeves. It must not become ADR/HK arbitrage, conversion arbitrage, pair trading, short selling, margin, or after-hours trading.

新增 `hk_us_adr_hk_secondary_listing_lead_lag_overlay` 作为 research-only cross-market lead-lag / price-discovery overlay。研究重点是验证 US ADR overnight / day-session moves、HK secondary-listing close / open alignment、ADR ratio、USD/HKD FX、after-hours / pre-market context、holiday mismatch 和 conversion / fungibility constraints 是否能改善港股 China-tech、大盘动量、ETF rotation、weekly reversal 与 event sleeves 的 confirmation 或 de-risking。它不能成为 ADR/HK arbitrage、conversion arbitrage、pair trading、short selling、margin 或 after-hours trading 策略。

Promotion blockers: new profile/contract only; point-in-time HKEX secondary-listing records, issuer company information sheets, ADR ratio / depository data, adjusted HK and US closes, USD/HKD FX, corporate actions, holiday mismatch, primary/secondary listing status, delisting and conversion constraints; same-universe ablation versus liquid momentum, weekly reversal, dually traded reversal, AH premium, Stock Connect flow, ETF rotation, index-derivative and event overlays; cost, spread, lot-size, VCM/CAS, suspension, broker-permission and capacity stress; walk-forward evidence with max drawdown <= 30%, every OOS fold drawdown <= 30%, positive net excess return after costs, dry-run order previews, bilingual notifications, rollout controls, and operator approval.


## 2026-06-02 smart beta factor-regime rotation overlay

`hk_smart_beta_factor_regime_rotation_overlay` is added as a research-only factor-regime allocation overlay. The research thesis is to test whether Hong Kong smart-beta factor sleeves across value, dividend/yield, low volatility, quality, momentum, and size can be tilted by market-cycle, volatility, investor-sentiment, liquidity, and macro-regime evidence while preserving low turnover and <=30% drawdown constraints. It must not become black-box market timing, high-turnover factor chasing, leveraged trading, shorting, derivatives trading, or intraday trading.

新增 `hk_smart_beta_factor_regime_rotation_overlay` 作为 research-only factor-regime allocation overlay。研究重点是验证港股 smart-beta factor sleeves 中的 value、dividend/yield、low-volatility、quality、momentum 和 size 是否可以通过 market-cycle、volatility、investor-sentiment、liquidity 和 macro-regime evidence 做低换手倾斜，并保持最大回撤 <=30%。它不能成为黑箱 market timing、高换手 factor chasing、杠杆、做空、衍生品或 intraday trading 策略。

Promotion blockers: new profile/contract only; point-in-time HSI / HSCI factor methodology versions, constituents, factor scores, factor returns, rebalance buffers, weight caps, sector classifications, market-cycle labels, volatility / sentiment / macro-state labels, factor correlations, turnover, capacity and costs; same-universe ablation versus static factor mix, QVLM risk parity, quality-yield, quality-growth low-volatility, residual/liquid momentum, value-quality, ETF rotation and cash/02800 defensive baselines; stress tests for regime misclassification, whipsaw rotation, momentum crash, value trap, dividend trap, low-volatility crowding, factor-correlation breakdown, sector concentration, Southbound eligibility changes, HK costs, VCM/CAS and suspensions; walk-forward evidence with max drawdown <= 30%, every OOS fold drawdown <= 30%, positive net excess return after costs, dry-run order previews, bilingual notifications, rollout controls, and operator approval.

## 2026-06-02 ESG downside-risk quality overlay

`hk_esg_downside_risk_quality_overlay` is added as a research-only ESG downside-risk / quality-governance overlay. The research thesis is to test whether point-in-time HSI ESG Enhanced methodology, ESG Risk Rating / UNGC / controversial-product screening, constituent exclusions, tilt factors, industry caps, provider-version history, news-sentiment context and institutional-flow evidence can reduce volatility-spike downside risk when applied to quality, yield, low-volatility, smart-beta, ETF and event sleeves. It must not become ESG label-chasing, greenwashing-sensitive marketing, high-turnover controversy trading, short-selling, derivatives trading, or standalone ESG timing.

新增 `hk_esg_downside_risk_quality_overlay` 作为 research-only ESG downside-risk / quality-governance overlay。研究重点是验证 point-in-time HSI ESG Enhanced methodology、ESG Risk Rating / UNGC / controversial-product screening、constituent exclusion、tilt factor、industry cap、provider-version history、news-sentiment context 和 institutional-flow evidence 是否能在 quality、yield、low-volatility、smart-beta、ETF 与 event sleeves 上降低 volatility-spike downside risk。它不能成为 ESG label-chasing、greenwashing-sensitive marketing、高换手 controversy trading、做空、衍生品或 standalone ESG timing 策略。

Promotion blockers: new profile/contract only; point-in-time ESG rating / UNGC / controversial-product / provider-version / methodology-change / missing-rating history; HSI ESG Enhanced constituent exclusion, Z-score, tilt-factor, industry-cap and rebalance history; same-universe ablation versus quality-yield, quality-growth low-volatility, regulatory enforcement, connected-transaction governance, smart-beta factor-regime, downside-risk volatility, ETF rotation and cash/02800 defensive baselines; stress tests for volatility spikes, China policy/property drawdowns, ESG data-provider methodology changes, missing coverage, rating lag, greenwashing / controversy reversals, sector concentration, crowded defensive tilts, Southbound eligibility changes, HK costs, VCM/CAS and suspensions; walk-forward evidence with max drawdown <= 30%, every OOS fold drawdown <= 30%, positive net excess return after costs, dry-run order previews, bilingual notifications, rollout controls, and operator approval.
